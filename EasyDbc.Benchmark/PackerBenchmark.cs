...
namespace EasyDbc.Benchmark
{
    public class PackerBenchmark
    {
        private Signal EightByte_BigEndian_Signal1 = new Signal();
        private Signal EightByte_BigEndian_Signal2 = new Signal();
        private Signal EightByte_BigEndian_Signal3 = new Signal();
        private Signal EightByte_BigEndian_Signal4 = new Signal();

        private Signal EightByte_LittleEndian_Signal1 = new Signal();
        private Signal EightByte_LittleEndian_Signal2 = new Signal();
        private Signal EightByte_LittleEndian_Signal3 = new Signal();
        private Signal EightByte_LittleEndian_Signal4 = new Signal();

        private Signal LittleEndian_Unsigned_NoScale = new Signal();
